...
//        app.buttons["TabTrayController.menuButton"].tap()
    ...
    func testSample() {
        ...
        app/*@START_MENU_TOKEN@*/.buttons["TabTrayController.addTabButton"]/*[[".otherElements[\"Tabs Tray\"]",".buttons[\"Add Tab\"]",".buttons[\"TabTrayController.addTabButton\"]"],[[[-1,2],[-1,1],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/.tap()
